...
public class DateTimeGenerator {
    ...
    public static LocalDate generateDate() { //генерация случайного дня в диапазоне min max
    ...
    public static List<LocalTime> generateTimeList() {
        ...
        int size = ThreadLocalRandom.current().nextInt(1, 5); //генерирует случайное число от 1 до 5
        for (int i = 0; i < size; i++) {
            timeList.add(generateTime()); // добавляет рандомное время
        }
        return timeList;
    }
