...
public class Solution {
    ...
    static void addUser(User user) {
        ...
        switch (user.setName(name)){
            ...
            case -1 : System.out.println(CANNOT_BE_NULL); break;
            case -2 : System.out.println(CANNOT_BE_EMPTY); break;
            case -3 : System.out.println(CANNOT_CONTAIN_DIGIT); break;
            default : System.out.println(UNKNOWN_ERROR); break;
        }
    ...
    static void findUserIndex(User user) {
        switch (users.indexOf(user)){
            case -1 : System.out.printf(NOT_FOUND, user.getName()); break;
            default : System.out.printf(FOUND, user.getName(), users.indexOf(user)); break;
        }
    }
}
